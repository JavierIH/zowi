...
ui.addImage("zobi_amarillo.png",0, 0, 1280, 720);
...
function init_gui() {
    ...
    var btnGF = addMyButton(x + w, y + h, "mover_abajo.png", GREEN_F);
    var btnGL = addMyButton(x, y, "mover_izquierda.png", GREEN_L);
    var btnGR = addMyButton(x + 2*w, y, "mover_derecha.png", GREEN_R);
    var btnGB = addMyButton(x + w, y - h, "mover_arriba.png", GREEN_B);
    
    var btnBF = addMyButton(2.5 * x + 4*w + 50, y + h, "bailar_abajo.png", BLUE_F);
    var btnBL = addMyButton(2.5 * x + 3*w + 50, y, "bailar_izquierda.png", BLUE_R);
    var btnBR = addMyButton(2.5 * x + 5*w + 50, y, "bailar_derecha.png", BLUE_L);
    var btnBB = addMyButton(2.5 * x + 4*w + 50, y - h, "bailar_arriba.png", BLUE_B);
    
    var btnStop = addMyButton(ui.screenWidth / 2 - 75, 40,  "stop5.png", STOP);
}
